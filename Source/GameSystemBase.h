...
public:
	...
	SimplerGameSimSystem* physics_system;


//----------
	phys::vec3 camera_pos;
	phys::vec3 camera_pos_game_offset;

	double camera_original_r;

	phys::vec3_spherical camera_rotation; //around the point that the camera is focusing at (camera_pos + camera_pos_game_offset)
//----------

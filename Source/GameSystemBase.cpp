...
{
	//mouse_pointer_tex.SetScale(0.002*camera_rotation.r);
	//mouse_pointer_tex.DrawMe(GetMousePos_GLcoords().x, GetMousePos_GLcoords().y);

	//mouse_pointer_tex.DrawMe(GetMousePos_Wincoords().x, GetMousePos_Wincoords().y);
	...
	*/
	...
	/*
	mouse_pointer_tex.SetScale(camera_rotation.r);

	mouse_pointer_tex.DrawMe(GetMousePos_Wincoords().x - global_window_info.WindowWidth_half_f,
							GetMousePos_Wincoords().y - global_window_info.WindowHeight_half_f);
	*/
}
